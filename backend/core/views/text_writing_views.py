...
from core.serializers import TextWritingSerializer, TextWritingCreateSerializer
...
def text_writing_detail(request, text_writing_id):
    ...
    if request.method == "GET":
        ...
        serializer = TextWritingSerializer(text_writing, data=request.data, partial=True)
