...
class PracticeGrammarViewsTest(TestCase):
    ...
    def test_practice_grammar_update(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.patch(f'/api/choice_grammar/{self.practice_grammar.id}/', data=data, format='json')
    ...
    def test_practice_grammar_delete(self):
        self.client.force_authenticate(user=self.user)
        response = self.client.delete(f'/api/choice_grammar/{self.practice_grammar.id}/')
