...
class GrammarViewsTest(TestCase):
    ...
    def test_grammar_update_put(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.put(f'/api/grammar/{self.grammar.pk}/', data=data, format='json')
    ...
    def test_grammar_update_patch(self):
        ...
        self.client.force_authenticate(user=self.user)
        response = self.client.patch(f'/api/grammar/{self.grammar.pk}/', data=data, format='json')
